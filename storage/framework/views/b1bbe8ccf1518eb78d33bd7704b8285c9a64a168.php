...
<head>
    ...
    <!--BOOTSTRAP IMPORTADO -->
     <link href="<?php echo e(asset ('site/bootstrap/dist/css/bootstrap.min.css')); ?>" rel="stylesheet">
...
<script type="text/javascript" src="<?php echo e(asset('/site/js/script.js')); ?>"></script>
<script src="<?php echo e(asset('site/bootstrap/dist/js/bootstrap.min.js')); ?>" rel="stylesheet"></script>
</body>
</html>
<?php /**PATH Z:\projetos\laravel\PIICUS\piicus\resources\views/site/layout.blade.php ENDPATH**/ ?>